package mod.bitsnblocks.client.screens.widgets;
...
import mod.bitsnblocks.api.client.screen.widget.AbstractChiselsAndBitsWidget;
import mod.bitsnblocks.api.util.LocalStrings;
import mod.bitsnblocks.client.icon.IconManager;
import mod.bitsnblocks.network.packets.ClearChangeTrackerPacket;
    ...
    public void init()
    {
        ...
        this.undoButton = owner.addRenderableWidget(
          new GuiIconButton(
            ...
            button -> BitsNBlocks.getInstance().getNetworkChannel().sendToServer(new RequestChangeTrackerOperationPacket(false)),
        ...
        this.redoButton = owner.addRenderableWidget(
          new GuiIconButton(
            ...
            button -> BitsNBlocks.getInstance().getNetworkChannel().sendToServer(new RequestChangeTrackerOperationPacket(true)),
        ...
        this.clearButton = owner.addRenderableWidget(
          new GuiIconButton(
            ...
            button -> BitsNBlocks.getInstance().getNetworkChannel().sendToServer(new ClearChangeTrackerPacket()),
