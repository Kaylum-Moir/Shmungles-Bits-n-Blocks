    ...
    private void doCameraTransformForType(final ItemDisplayContext cameraTransformType, final PoseStack mat, final boolean requiresStackPush)
    {
        switch (cameraTransformType)
        {
            case FIRST_PERSON_LEFT_HAND:
                mod.bitsnblocks.client.util.TransformationUtils.push(mat, firstPerson_lefthand, requiresStackPush);
                break;
            case FIRST_PERSON_RIGHT_HAND:
                mod.bitsnblocks.client.util.TransformationUtils.push(mat, firstPerson_righthand, requiresStackPush);
                break;
            case THIRD_PERSON_LEFT_HAND:
                mod.bitsnblocks.client.util.TransformationUtils.push(mat, thirdPerson_lefthand, requiresStackPush);
                break;
            case THIRD_PERSON_RIGHT_HAND:
                mod.bitsnblocks.client.util.TransformationUtils.push(mat, thirdPerson_righthand, requiresStackPush);
                break;
            case GROUND:
                mod.bitsnblocks.client.util.TransformationUtils.push(mat, ground, requiresStackPush);
                break;
            case GUI:
                mod.bitsnblocks.client.util.TransformationUtils.push(mat, gui, requiresStackPush);
                break;
            case FIXED:
            default:
                mod.bitsnblocks.client.util.TransformationUtils.push(mat, fixed, requiresStackPush);
                break;
        }
    }
