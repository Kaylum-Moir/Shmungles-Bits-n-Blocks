package mod.bitsnblocks.client.input;

import com.communi.suggestu.scena.core.dist.Dist;
import com.communi.suggestu.scena.core.dist.DistExecutor;
import mod.bitsnblocks.BitsNBlocks;
import mod.bitsnblocks.input.ProcessingInputTracker;
import mod.bitsnblocks.network.packets.InputTrackerStatusUpdatePacket;
...
public final class FrameBasedInputTracker
{
    ...
    private final InputTracker leftMouseTracker = new InputTracker(
      ...
      () -> {
          BitsNBlocks.getInstance().getNetworkChannel().sendToServer(new InputTrackerStatusUpdatePacket(true, true));
      ...
      () -> {
          BitsNBlocks.getInstance().getNetworkChannel().sendToServer(new InputTrackerStatusUpdatePacket(true, false));
    ...
    private final InputTracker rightMouseTracker = new InputTracker(
      ...
      () -> {
          BitsNBlocks.getInstance().getNetworkChannel().sendToServer(new InputTrackerStatusUpdatePacket(false, true));
      ...
      () -> {
          BitsNBlocks.getInstance().getNetworkChannel().sendToServer(new InputTrackerStatusUpdatePacket(false, false));
